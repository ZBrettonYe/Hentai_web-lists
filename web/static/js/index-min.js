...
var searchEngineLogoBox = $(".search-engine .search-logo"),
    ...
    searchEngineLogoPath = staticServerURI + "static/img/";
(function (f, h) {
    var a = {},
        e = $("#search-engine"),
    ...
    $.extend(!0, a, {
        ...
        onSuggestListChange: function () {
            ...
            !$.isEmptyObject(d) && 0 >= d.length ? a.search_hint_hide() : $.isEmptyObject(d) || (a.search_hint_show(), d.on("mouseover mouseout click",
                function (d) {
...
(function (f, h) {
    ...
    $.extend(!0, a, {
        ...
        headerBreathUp: function () {
            a.currentAlfa += .01;
            a.headerView.css("background-color", "rgba(15,25,50," + a.currentAlfa + ")");
            .4 <= a.currentAlfa ? setTimeout(function () {
                    a.headerBreathDown()
                },
        ...
        headerBreathDown: function () {
            a.currentAlfa -= .01;
            a.headerView.css("background-color", "rgba(15,25,50," + a.currentAlfa + ")");
            .1 >= a.currentAlfa ? setTimeout(function () {
                    a.headerBreathUp()
                },
        ...
        onHeaderMenuClick: function (e) {
            ...
            switch (e) {
                ...
                case "help-info":
                    ...
                    c = function () {
                        MyHelpInfo.helpPicLoaded || $("#help-info-pic").attr("src", staticServerURI + "../img/helpinfo/function.png");
...
(function (f, h) {
    ...
    $.extend(!0, a, {
        ...
        loadIcons: function () {
            a.isLoadPic = !0;
            var b = staticServerURI + "../img/icon/";
